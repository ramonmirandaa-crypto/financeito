...
function GlassFilter({ id }: { id: string }) {
  return (
    <svg className="absolute w-0 h-0" style={{ position: 'absolute', left: '-9999px' }}>
      <defs>
        <filter
          id={id}
          x="0%"
  ...
  return (
    <>
      <Comp
        ...
        {...props}
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full backdrop-blur-sm
        ...
        <div
          className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-md backdrop-blur-sm"
